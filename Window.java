...
public class Window extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
	    ...
	    numbers.setText("If you would like to reject any changed words, do so here by entering the index of the word in the list in ''words changed'' (first list is 0, second list is 1, etc.) separated by a space each. DO NOT PRESS ENTER AND DELETE THIS TEXT FIRST!");
    }
}
